...
[![License](https://img.shields.io/github/license/Minespree/Babel.svg)](LICENSE)
![Documentation](https://img.shields.io/badge/docs-javadocs-green.svg)

This is the code that powered the Bukkit translation system of the former Minespree Network.
...
To build Babel, the following will need to be installed and available from your shell:
...
Babel is required by other packages and as so, you will need to install it to your local `.m2` repo by running:
...
* Message and language manager (these are both loaded from external sources such as MongoDB on the [Feather](https://github.com/Minespree/Feather) project)
* Message types such as multiline, complex and simple types.
* [Supported languages](src/main/java/net/minespree/babel/SupportedLanguage.java) enum
...
Babel is free software: you can redistribute it and/or modify it under the terms of the GNU Affero General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.
